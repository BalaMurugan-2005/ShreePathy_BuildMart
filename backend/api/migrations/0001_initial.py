    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('CUSTOMER', 'Customer'), ('SUPPLIER', 'Supplier'), ('ADMIN', 'Admin')], default='CUSTOMER', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='materials', to='api.category')),
                ('supplier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='materials_supplied', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='api.material')),
            ],
        ),
        migrations.CreateModel(
